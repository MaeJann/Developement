...
for extend in extend_range:
    ...
    XPL_textures = ext_text(max_xpl, x_min,x_max, y_min, y_max, 2)
    XPL_textures = normalize(XPL_textures)
    
    Feature_Names = ["PPL-H", "PPL-S", "PPL-V", "XPL-H", "XPL-S", "XPL-V", "PPL-H-STD", "PPL-S-STD", "PPL-V-STD", "XPL-H-STD", "XPL-S-STD", "XPL-V-STD","PPL-I-Cont", "PPL-I-Diss", "PPL-I-Hom", "PPL-I-ASM", "PPL-I-E", "PPL-I-Cor", "PPL-I-Cont", "PPL-I-Diss", "PPL-I-Hom", "PPL-I-ASM", "PPL-I-E", "PPL-I-Cor"]
    #%% Combine extracted features to feature matrix
    
    Features = np.hstack((PPL_Color, XPL_Color, PPL_std, XPL_std, PPL_textures, XPL_textures))
    Features = pd.DataFrame(Features)
    filepath = "C:/Users/j-mae/Desktop/Master Thesis/Image Data/Test Data/Merged Data/Naxos_Boudin_8/Extracted/Featurematrix/"
    filename = (filepath + 'Featurematrix_extend_'+ str(extend) + '.csv')
    Features.to_csv(filename, sep = ';', header = Feature_Names)
